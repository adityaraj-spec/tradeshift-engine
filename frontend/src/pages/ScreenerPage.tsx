            ...
            {filteredCandidates.map((stock, idx) => (
              ...
              >
                ...
                <Button
                  ...
                  className="w-full mt-4 bg-slate-100 dark:bg-white/5 hover:bg-primary hover:text-white text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-white/10 hover:border-transparent transition-all duration-300 rounded-xl group-hover:translate-y-[-2px]"
                >
                  Start Deep Learning
