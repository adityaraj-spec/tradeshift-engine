...
const ScreenerPage: React.FC = () => {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] h-full">
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-400 animate-pulse font-medium">FinGPT Scanning NSE Markets...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      {/* Header Banner */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/10 via-blue-500/5 to-white dark:to-[#050505] border border-gray-200 dark:border-white/5 p-8 shadow-sm dark:shadow-2xl m-3">
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="space-y-4 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2">
              <div className="px-2 py-0.5 bg-amber-100 dark:bg-amber-500/20 text-amber-600 dark:text-amber-500 rounded text-[10px] font-black uppercase tracking-widest border border-amber-200 dark:border-amber-500/30">
                Varsity Powered
              </div>
          ...
          <div className="flex gap-4">
            <div className="p-5 bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-2xl backdrop-blur-xl group hover:border-primary/50 transition-all">
              <div className="text-[10px] text-gray-500 font-bold uppercase mb-1 flex items-center gap-2">
                <Target className="w-3 h-3" />
                Market Coverage
              </div>
              <div className="text-3xl font-black text-gray-900 dark:text-white group-hover:text-primary transition-colors pl-2">Global</div>
            </div>
            <div className="p-5 bg-green-50 dark:bg-black/40 border border-green-200 dark:border-white/10 rounded-2xl backdrop-blur-xl group hover:border-green-500/50 transition-all text-center">
              <div className="text-[10px] text-gray-500 font-bold uppercase mb-1">Status</div>
              <div className="text-3xl font-black text-green-600 dark:text-green-500">Live</div>
            </div>
          </div>
        </div>
      ...
      <Tabs defaultValue="multibagger" className="w-full">
        ...
        <TabsContent value="multibagger" className="space-y-8 mt-0">
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/5 p-4 rounded-lg m-3 shadow-sm dark:shadow-none">
            <div className="flex flex-wrap gap-2 w-full lg:w-auto justify-center">
              {['All', 'Banking', 'Energy', 'IT', 'Consumer', 'FMCG'].map(cat => (
                <Button
                  ...
                  className={`rounded-xl text-sm font-bold ${category === cat ? 'bg-gray-200 dark:bg-white/10 text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5'}`}
                >
                  {cat}
                </Button>
              ))}
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto justify-center">
              <div className="relative w-full sm:w-64">
                <input
                  ...
                  className="w-full bg-white dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-xl py-2 pl-10 pr-4 font-bold text-sm text-gray-900 dark:text-white focus:outline-none focus:border-primary/50 transition-colors placeholder:text-gray-400 dark:placeholder:text-gray-500"
                />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 m-3">
            {filteredCandidates.map((stock, idx) => (
              <div
                key={stock.symbol}
                className="group relative bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-white/5 rounded-lg p-6 hover:border-gray-300 dark:hover:border-primary/50 transition-all duration-500 hover:shadow-xl dark:hover:shadow-[0_0_30px_-10px_rgba(59,130,246,0.3)] flex flex-col justify-between shadow-sm dark:shadow-none"
              ...
              >
                <div className="space-y-4">
                  <div className="flex justify-between items-start">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        <h3 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{stock.symbol}</h3>
                        <TrendingUp className="w-4 h-4 text-green-600 dark:text-green-500" />
                      </div>
                      <p className="text-xs text-gray-500 font-medium truncate max-w-[150px] ml-1">{stock.name}</p>
                    </div>
                    <div className="flex flex-col items-end">
                      ...
                      <span className="text-[10px] text-gray-500 mt-1 uppercase font-bold tracking-tighter">Conviction Score</span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="px-2 py-1 bg-gray-100 dark:bg-white/5 rounded-md text-[10px] font-bold text-gray-600 dark:text-gray-400 uppercase">{stock.sector}</span>
                  </div>

                  {/* Varsity Tip */}
                  <div className="p-3 bg-blue-50 dark:bg-blue-500/5 border border-blue-200 dark:border-blue-500/10 rounded-2xl relative group/tip">
                    <div className="flex items-center gap-2 mb-1">
                      <BrainCircuit className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400" />
                      <span className="text-[10px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-tighter">Why this stock?</span>
                    </div>
                    <p className="text-[10px] text-gray-600 dark:text-gray-500 leading-relaxed italic line-clamp-2 group-hover/tip:line-clamp-none transition-all">
                      "{stock.varsity_tip}"
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-y-4 gap-x-2 pt-2">
                    <div className="space-y-1">
                      ...
                      <div className="text-lg font-black text-gray-900 dark:text-white">{stock.roce}%</div>
                    </div>
                    <div className="space-y-1">
                      <div className="text-[10px] text-gray-500 flex items-center gap-1 uppercase font-bold tracking-wider">
                      ...
                      <div className="text-lg font-black text-white">{stock.roe || (stock.roce > 0 ? (stock.roce - 2).toFixed(1) : 0)}%</div>
                    </div>
                    <div className="space-y-1">
                      <div className="text-[10px] text-gray-500 flex items-center gap-1 uppercase font-bold tracking-wider">
                      ...
                      <div className="text-lg font-black text-gray-900 dark:text-white">{stock.revenue_growth}%</div>
                    </div>
                    <div className="space-y-1">
                      <div className="text-[10px] text-gray-500 flex items-center gap-1 uppercase font-bold tracking-wider">
                      ...
                      <div className="text-lg font-black text-gray-900 dark:text-white">{stock.pe_ratio}x</div>
                    </div>
                    <div className="space-y-1">
                      <div className="text-[10px] text-gray-500 flex items-center gap-1 uppercase font-bold tracking-wider">
                      ...
                      <div className="text-lg font-black text-gray-900 dark:text-white">₹{(stock.market_cap / 1000).toFixed(1)}k Cr</div>
                    </div>
                  </div>
                </div>
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full mt-4 border-gray-200 dark:border-white/5 hover:bg-gray-100 dark:hover:bg-white/10 text-gray-900 dark:text-white transition-all duration-300 rounded-xl group-hover:translate-y-[-2px]"
                >
                  Start Deep Learning
          ...
          {/* Methodology Section */}
          <div className="p-6 bg-white dark:bg-white/[0.01] border border-gray-200 dark:border-white/5 rounded-lg flex flex-col md:flex-row items-center gap-6 m-3 shadow-sm dark:shadow-none">
            <div className="p-4 bg-blue-100 dark:bg-blue-500/10 rounded-full">
              <Info className="w-8 h-8 text-blue-600 dark:text-blue-400" />
            </div>
            <div className="flex-1 space-y-1">
              <h4 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider">How we pick multibaggers</h4>
              <p className="text-xs text-gray-600 dark:text-gray-500 leading-relaxed max-w-3xl">
            ...
            <Button variant="outline" className="text-xs border-gray-200 dark:border-white/10 hover:bg-gray-100 dark:hover:bg-white/5 text-gray-600 dark:text-white">View Full Logic</Button>
          </div>
        </TabsContent>

        <TabsContent value="pro" className="mt-0">
          <div className="bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-white/5 rounded-3xl p-6 overflow-hidden shadow-sm dark:shadow-none">
            <TradingViewWidget
