    ...
    <div ref={containerRef} className="market-journey-root" style={{
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', perspective: '1200px', zIndex: 10 }}>
        ...
        {/* =========================================
            ...
            ========================================= */}
        <div ref={introLayerRef} style={{ position: 'absolute', textAlign: 'center', top: '25%', width: '100%' }}>
           ...
           <p style={{ fontSize: '1.5rem', color: '#ccc', maxWidth: '600px', margin: '0 auto', lineHeight: 1.6 }}>
        ...
        {/* =========================================
            ...
            ========================================= */}
        {/* Card 1: Giants */}
        <div ref={card1Ref} style={{ position: 'absolute', width: '90%', maxWidth: '800px', textAlign: 'center' }}>
        ...
        <div ref={card2Ref} style={{ position: 'absolute', width: '90%', maxWidth: '800px', textAlign: 'center' }}>
        ...
        {/* Card 3: Price Action */}
        <div ref={card3Ref} style={{ position: 'absolute', width: '90%', maxWidth: '800px', textAlign: 'center' }}>
        ...
        {/* Card 4: Indicators */}
        <div ref={card4Ref} style={{ position: 'absolute', width: '90%', maxWidth: '800px', textAlign: 'left' }}>
          <div className="card-header">
        ...
        {/* Card 5: Ecosystem */}
        <div ref={card5Ref} style={{ position: 'absolute', width: '90%', maxWidth: '800px', textAlign: 'center' }}>
        ...
        {/* =========================================
            ...
            ========================================= */}
         <div ref={decisionLayerRef} style={{ position: 'absolute', width: '100%', maxWidth: '800px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
        ...
        {/* =========================================
            ...
            ========================================= */}
         <div ref={psychologyLayerRef} style={{ position: 'absolute', width: '100%', textAlign: 'center' }}>
        ...
        {/* =========================================
            ...
            ========================================= */}
         <div ref={exitLayerRef} style={{ position: 'absolute', textAlign: 'center', pointerEvents: 'none' }}>
